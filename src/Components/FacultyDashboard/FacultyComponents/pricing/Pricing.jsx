...
import './Pricing.css';
import Image1 from '../../../../assets/Faculty/price-1.svg';
import Image2 from '../../../../assets/Faculty/price-2.svg';
import Image3 from '../../../../assets/Faculty/price-3.svg';
        ...
        <section className="pricing container section">
            ...
            <div className="pricing__container grid">
                <div className="pricing__item">
                   ...
                   <h3 className="h3 pricing__plan">Basic</h3>
                ...
                <div className="pricing__item best">
                   ...
                   <h3 className="h3 pricing__plan">Premium</h3>
                ...
                <div className="pricing__item">
                   ...
                   <h3 className="h3 pricing__plan">Ultimate</h3>
